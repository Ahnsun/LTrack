...
import util.dist as comm
from util import configure_nccl
...
def launch_by_subprocess(
    ...
    if dist_url is None:
        ...
        if num_machines > 1:
            ip_add_file = "./" + args.experiment_name + "_ip_add.txt"
            if machine_rank == 0:
...
def _distributed_worker(
    ...
    if global_rank == 0 and os.path.exists(
        "./" + args.experiment_name + "_ip_add.txt"
    ):
        os.remove("./" + args.experiment_name + "_ip_add.txt")
