...
class Detector(object):
    def __init__(self, args, model=None, seq_num=2):
        ...
        img_list = os.listdir(os.path.join(self.args.mot_path, 'MOT15/images/test', self.seq_num, 'img1'))
        img_list = [os.path.join(self.args.mot_path, 'MOT15/images/test', self.seq_num, 'img1', _) for _ in img_list if
    ...
    def detect(self, prob_threshold=0.7, area_threshold=100):
        ...
        filter_pub_det(os.path.join(self.predict_path, f'{self.seq_num}.txt'),
                        f'/data/datasets/MOT/MOT15/images/test/{self.seq_num}/det/det.txt')
