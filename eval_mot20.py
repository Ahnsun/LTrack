...
class Detector(object):
    def __init__(self, args, model=None, seq_num=2):
        ...
        img_list = os.listdir(os.path.join(self.args.mot_path, 'MOT20/images/train', self.seq_num, 'img1'))
        img_list = [os.path.join(self.args.mot_path, 'MOT20/images/train', self.seq_num, 'img1', _) for _ in img_list if
    ...
    def eval_seq(self):
        data_root = os.path.join(self.args.mot_path, 'MOT20/images/train')
