...
from tools.meg_launch import launch
import datasets
...
def get_args_parser():
    ...
    parser.add_argument('--mot_path', default='/data/datasets/MOT', type=str)
    ...
    # multi-machine
    parser.add_argument('--use_multi_machine', action='store_true', default=False)
    parser.add_argument("-expn", "--experiment-name", type=str, default=None)
    parser.add_argument('--num_machines', default=0, type=int, help='num of node for training')
