...
class MOTR(nn.Module):
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels, criterion, track_embed,
        ...
        # self.dia_encoder = DilatedEncoder()
    ...
    def _forward_single_image(self, samples, track_instances: Instances):
        ...
        hs, init_reference, inter_references, enc_outputs_class, memory = self.transformer(srcs, masks, pos, track_instances.query_pos, ref_pts=track_instances.ref_pts)

        visual_context = memory  # B, N, C
